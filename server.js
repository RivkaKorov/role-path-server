...
Do not include any other text or explanations.`;
    ...
    // Validate schema: either {} or array of 3 objects with question and options array of 3
...
app.post('/api/generate-learning-path', async (req, res) => {
  try {
    ...
    // Validate schema: object with topics array of 3 objects, each with topic string and links array of 4 strings
